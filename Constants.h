//////////// НАСТРОЙКИ ////////////
#define Version_Firmware  "2_beta_1"        // версия прошивки
...
#define DOT_TEMP            0               // задаем точку десятых для температуры, 0 или 1
...
struct Clock {
  ...
  bool type_sec = 1;               // режим мигания секунд, 0 - 1р/с, 1 - 2р/с
                                   // режимы часов
                                   // 0 - часы, 1 - комнатная температура, 2 - уличная температура, 3 - давление, 4 - влажность, !!255 - обязательный последний маркер!!
...
struct Monitoring {
  bool Monitoring = true;  // включаем мониторинг, иначе false
